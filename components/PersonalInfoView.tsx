...
type EditingField = 'name' | 'gender' | 'phone' | null;
            ...
            {infoItems.map((item, idx) => (
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  <span className={`text-sm font-black ${item.type === 'readonly' ? 'text-gray-400' : 'text-gray-900 dark:text-white'}`}>
                    {item.value}
                  </span>
          ...
          <div className="relative bg-white dark:bg-slate-900 rounded-t-[40px] p-8 pb-12 space-y-6 shadow-2xl animate-in slide-in-from-bottom-10 border-t border-white/20 max-w-md mx-auto w-full">
            <div className="flex justify-between items-center">
              <h4 className="text-xl font-black text-gray-800 dark:text-white tracking-tight">
                修改{editingField === 'name' ? '名稱' : editingField === 'gender' ? '性別' : '手機號碼'}
              </h4>
              <button 
            ...
            {editingField === 'gender' ? (
              ...
              <div className="space-y-1">
                ...
                <input 
                  ...
                  placeholder={`請輸入${editingField === 'name' ? '名稱' : '手機號'}`}
                />
              </div>
            )}
